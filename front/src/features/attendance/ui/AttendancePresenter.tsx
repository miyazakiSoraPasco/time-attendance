    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="relative overflow-hidden bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 p-8 md:p-12">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <Typography variant="h1" className="text-5xl md:text-6xl font-black text-gray-900 tracking-tight tabular-nums mb-4">
          ...
          <div className="w-full md:w-72">
            <Card className={`border-none shadow-none ${currentStatus.bgColor} rounded-3xl p-6 transition-colors duration-500`}>
              <div className="flex flex-col items-center text-center">
                ...
                <Typography variant="h3" className={`text-xl font-bold mb-2 ${currentStatus.color}`}>{currentStatus.text}</Typography>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Button
          ...
          className="h-24 rounded-3xl text-lg font-bold gap-3 transition-all active:scale-95 shadow-lg"
          variant={status === 'working' ? 'secondary' : 'secondary'} // Actual color was amber, need variant or style
          style={status === 'working' ? { backgroundColor: '#f59e0b', color: 'white' } : {}}
        >
          <Coffee size={24} />
          休憩
        </Button>
        ...
        <Button
          ...
          className="h-24 rounded-3xl text-lg font-bold gap-3 transition-all active:scale-95 shadow-lg"
          variant={status !== 'out' ? 'secondary' : 'secondary'}
          style={status !== 'out' ? { backgroundColor: '#111827', color: 'white' } : {}}
        >
          <LogOut size={24} />
          退勤
        </Button>
        ...
        <Card className="border-none shadow-sm rounded-3xl bg-blue-600 text-white p-8">
          <div className="h-full flex flex-col justify-between">
            <div>
              ...
              <Typography variant="h3" className="text-4xl font-black tracking-tight mb-6">
